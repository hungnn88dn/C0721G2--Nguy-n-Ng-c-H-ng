...
import repository.BookingServiceRepo;
...
public class BookingRepoImpl implements BookingServiceRepo {
    static File file = new File("src\\data\\booking.csv");
    static Scanner scanner = new Scanner(System.in);
    FacilityRepoImpl facilityService = new FacilityRepoImpl();
    ...
    @Override
    public void display() {
        Set<Booking> list = BookingRepoImpl.readBooking();
    ...
    @Override
    public void add() {
        Set<Booking> listBookings = BookingRepoImpl.readBooking();
        int customerCode = CustomerRepoImpl.checkMember();
        ...
        BookingRepoImpl.writerBooking(listBookings);
    }
