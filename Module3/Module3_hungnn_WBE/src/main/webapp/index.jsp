...
<html>
  ...
  <div class="container-fluid">
    ...
    <div class="row ">
      <div class="col-md-6 col-lg-2 col-sm-12  bg-danger h-100">
        <div class="row ">
      ...
      <div class="col-md-6 col-lg-10 col-sm-12  bg-white h-100">
        <div>
          <iframe width="1230" height="692" src="https://www.youtube.com/embed/CaIhgUtGh48" title="YouTube video player" frameborder="0"
