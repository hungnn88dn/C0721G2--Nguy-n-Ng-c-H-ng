...
public class ContactServiceImpl implements ContractService {
    ...
    public static void checkBooking() {
        Set<Booking> bookingList = BookingServiceImpl.readBooking();
    ...
    @Override
    public void display() {
        Queue<Contract> contractLinkedList = ContactServiceImpl.readContract();
    ...
    @Override
    public void add() {
        ContactServiceImpl.checkBooking();
        ...
        ContactServiceImpl.writerContract(contractLinkedList);
    }
